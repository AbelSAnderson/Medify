...
class Medication extends ModelBase {
  ...
  Medication.fromJson(Map<String, dynamic> json) :
      this.id = json["id"],
      this.brandName = json["brand_name"] != null ? json["brand_name"] : '', // Potential fix on missing information - needs to be tested
      this.usage = json["indications_and_usage"], // Could also use dosage_and_administration
      this.precaution = json["warnings"], // Could also use other_safety_information
      this.dosage = json["dosage_and_administration"],
      this.ingredient = json["active_ingredient"]; // Could also use inactive_ingredient
}
